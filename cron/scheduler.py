...
def _job_profile_context(job_id: str, profile: Optional[str]):
    ...
    Cron jobs are stored and scheduled by the profile running the scheduler,
    but an individual job can opt into a different runtime profile. While
    active, a context-local Hermes home override points at the resolved profile
    ...
    try:
        ...
        # Delta-based restore: remove added keys, restore changed keys.  Avoids
        # a brief window where other threads see an empty env.
