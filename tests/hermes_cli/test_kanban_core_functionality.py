...
def test_default_spawn_auto_loads_builtin_worker_skills(kanban_home, monkeypatch):
    ...
    """
    # Pretend the built-in worker skills resolve for this isolated
    # HERMES_HOME — the fixture creates an empty tmpdir without the
    # profile/bundled skills tree, and _default_spawn gates the --skills
    # flags on actual resolvability.
    monkeypatch.setattr(kb, "_worker_skill_available", lambda _h, _skill: True)
