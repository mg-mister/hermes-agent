...
class TestBackendSelection:
    ...
    def test_fallback_no_keys_defaults_to_ddgs_when_available(self):
        """No keys, no config → free ddgs backend when the package is importable."""
        from tools.web_tools import _get_backend
        with patch("tools.web_tools._load_web_config", return_value={}), \
...
class TestCheckWebApiKey:
    ...
    def test_no_keys_returns_false_when_no_free_backend_available(self):
        from tools.web_tools import check_web_api_key
